...
import io.github.contractautomata.care.examples.compositionService.withoutCARE.utilities.AutoCloseableListExample;
...
public class OrchestratorCompositionExample implements Runnable {
    ...
    public OrchestratorCompositionExample(Automaton<String, Action, State<String>, ModalTransition<String, Action, State<String>, Label<Action>>> req,
    ...
    public String choice(AutoCloseableListExample<ObjectOutputStream> oout, AutoCloseableListExample<ObjectInputStream> oin)
        ...
        for (Integer i : toInvoke) {
            ...
            if ((selection.equals(OrchestratorCompositionExample.stop_choice)&&this.getCurrentState().isFinalState())
